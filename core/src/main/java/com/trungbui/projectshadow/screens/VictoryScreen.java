...
/**
 * Sprint 7 — terminal screen after defeating the boss. Shows a victory banner and
 * a Stage 2 placeholder note. Quit returns to OS.
 */
public class VictoryScreen implements Screen {
    ...
    public VictoryScreen(ProjectShadowGame game) {
        this.game = game;
    ...
    public void render(float delta) {
        Gdx.gl.glClearColor(0.10f, 0.12f, 0.06f, 1f);
